...
<body class="bg-gradient-to-br from-slate-50 to-blue-50">
    ...
    <nav class="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md shadow-sm animate-fadeInUp">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center gap-3 cursor-pointer">
                    <img src="{{ asset('assets/img/Logo_quickfix.png') }}"
                        alt="Logo QuickFix"
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="#home" class="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition font-medium">
                        <i data-lucide="home" class="w-5 h-5"></i> Beranda
                    </a>
                    <a href="#services" class="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition font-medium">
                        <i data-lucide="wrench" class="w-5 h-5"></i> Layanan
                    </a>
                    <a href="#features" class="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition font-medium">
                        <i data-lucide="star" class="w-5 h-5"></i> Fitur
                    </a>
                    <a href="#testimonials" class="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition font-medium">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t">
            <div class="px-4 py-4 space-y-3">
                ...
                <a href="#testimonials" class="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-blue-50 rounded-lg">
                    <i data-lucide="message-circle" class="w-5 h-5"></i> Testimoni
                </a>
                <a href="#contact" class="flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-lg text-center">
    ...
    <section id="home" class="relative min-h-screen flex items-center pt-20 overflow-hidden bg-white">
        ...
        <div class="absolute bottom-20 right-10 w-96 h-96 bg-cyan-400/20 rounded-full blur-3xl animate-float" style="animation-delay: 2s;"></div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="opacity-0 animate-slideInLeft">
                    ...
                    <h1 class="text-3xl md:text-5xl lg:text-6xl font-extrabold mb-4 leading-tight">
                        ...
                        <br>
                        <span class="text-gray-800">Teknisi On The Man</span>
                    </h1>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            <div class="text-2xl font-bold text-cyan-600">10K+</div>
                ...
                <div class="relative opacity-0 animate-slideInRight" style="animation-delay: 0.3s;">
                    <div class="relative">
                        ...
                        <div class="absolute inset-0 flex justify-center items-center -z-10">
                            <div class="w-[600px] h-[600px] bg-gradient-to-br from-blue-500/30 via-cyan-400/20 to-purple-400/30 rounded-[50%] blur-3xl animate-pulse-slow"></div>
                        </div>

                        <!-- Optional glowing ring -->
                        <div class="absolute inset-0 flex justify-center items-center -z-10">
                            <div class="w-[500px] h-[500px] rounded-full border-2 border-cyan-400/30 animate-spin-slow"></div>
                        </div>

                        <!-- Animated Technician Image -->
                        <div class="relative">
                            <img src="{{ asset('assets/img/teknisi.jpg') }}"
                                alt="Teknisi QuickFix"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 animate-fadeInUp">
                <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                    Mockup <span class="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Aplikasi Mobile</span>
                </h2>
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-12">
                ...
                <div class="relative animate-fadeInUp" style="animation-delay:0.2s;">
                    <div class="w-80 h-[520px] bg-gradient-to-br from-blue-100 to-cyan-100 rounded-[2.5rem] shadow-2xl border-4 border-white flex flex-col items-center justify-start overflow-hidden">
                        <!-- Status Bar -->
                        ...
                        <div class="w-full px-6 py-4 flex items-center gap-3">
                            ...
                            <span class="text-xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">QuickFix</span>
                        </div>
                        <!-- Main Content -->
                ...
                <div class="max-w-lg animate-fadeInUp" style="animation-delay:0.4s;">
                    ...
                    <a href="#" class="inline-block px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition">
                        Lihat Demo Aplikasi
                    </a>
                </div>
            </div>
    ...
    <section id="features" class="py-24 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 animate-fadeInUp">
                <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                    Kenapa Pilih <span class="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">QuickFix?</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition animate-fadeInUp" style="animation-delay:0.1s;">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition animate-fadeInUp" style="animation-delay:0.2s;">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition animate-fadeInUp" style="animation-delay:0.3s;">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition animate-fadeInUp" style="animation-delay:0.4s;">
    ...
    <section id="testimonials" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 animate-fadeInUp">
                <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                    Apa Kata <span class="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Pelanggan</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition animate-fadeInUp" style="animation-delay:0.1s;">
                    <div class="flex items-center gap-4 mb-6">
                        <img src="https://i.pravatar.cc/100?img=1" alt="User 1" class="w-16 h-16 rounded-full border-2 border-blue-500">
                        <div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition animate-fadeInUp" style="animation-delay:0.2s;">
                    <div class="flex items
                        .center gap-4 mb-6">
                        <img src="https://i.pravatar.cc/100?img=2" alt="User 2" class="w-16 h-16 rounded-full border-2 border-purple-500">
                        <div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition animate-fadeInUp" style="animation-delay:0.3s;">
                    <div class="flex items-center gap-4 mb-6">
                        <img src="https://i.pravatar.cc/100?img=3" alt="User 3" class="w-16 h-16 rounded-full border-2 border-green-500">
                        <div>
    ...
    <section id="contact" class="py-24 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 animate-fadeInUp">
                <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                    Hubungi <span class="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Kami</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                    Siap membantu Anda kapan saja, di mana saja
                </p>
            </div>
            <div class="max-w-3xl mx-auto bg-white rounded-2xl p-8 shadow-lg animate-fadeInUp" style="animation-delay:0.2s;">
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="4" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                    </div>
                    <div>
                        <button type="submit" class="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition">
                            Kirim Pesan
                        </button>
                    </div>
                </form>
